...
//=============================================
// Пишем код для выпадающего суб меню шапки
document.addEventListener("click", documentActions);

const menuBlocks = document.querySelectorAll('.sub-menu-catalog__block'); //автоматическое определение и присвоение класса выпадающего суб-мен
